            ...
            <div className={containerStyles.pageDataPreview__content}>
              ...
              {data?.data && !isEmpty(data.data) && (
                <div className={containerStyles.pageDataPreviewItem}>
                  <h3>Page Data</h3>
                  <JSONTree data={data.data} theme={theme} hideRoot />
                </div>
              )}
              {data?.pageContext && !isEmpty(data.pageContext) && (
                <div className={containerStyles.pageDataPreviewItem}>
                  <h3>Page Context</h3>
                  <JSONTree data={data.pageContext} theme={theme} hideRoot />
                </div>
              )}
              {data?.serverData && !isEmpty(data.serverData) && (
                <div className={containerStyles.pageDataPreviewItem}>
                  <h3>SSR Data</h3>
                  <JSONTree data={data.serverData} theme={theme} hideRoot />
                </div>
              )}
              {data?.location && !isEmpty(data.location) && (
                <div className={containerStyles.pageDataPreviewItem}>
                  <h3>Location Data</h3>
                  <JSONTree data={data.location} theme={theme} hideRoot />
                </div>
              )}
            </div>
          </div>
